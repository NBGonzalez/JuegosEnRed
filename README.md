...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/URJC_logo.svg/2560px-URJC_logo.svg.png)
...
Se ha decidido que el estilo general de *Virtual Velocity: Racing Unleashed* sea a modo pixel art en 2D. Se optará por un tono más animado y menos realista siguiendo las mecánicas y jugabilidad del videojuego.
...
- **Menú principal**: Contendrá las opciones de jugar, opciones, créditos y salir

- ***Jugar***: Una vez estemos en disposición de jugar una partida, aquí se elegirá el tipo de coche con su diseño y a continuación el circuito en el que se quiere competir. 
- ***Opciones***: Se podrá controlar valores in-game como el sonido o el formato de pantalla.
...
![](https://www.kijkwijzer.nl/media/0qiipnn5/pegi_3.png?anchor=center&mode=crop&width=800&height=534&quality=80&token=btpvwPSGh3)
...
Para realizar los [vehículos](#_2.2._tipos_de), [pistas,](#_2.4._circuitos) [iconos de Power-Ups,](#_2.3._power-ups) se han tomado en cuenta inspiración de distintos juegos como *Mario Kart*, así como buscar referencias por internet.



[Vista Cenital	](https://www.artstation.com/artwork/L26G0R)			[Vehículos](https://www.123rf.com/photo_41826971_pixel-art-game-cars-collection-vector-illustration.html)

Se han cogido ideas para los assets como farolas, señales, o cubos de la primera imagen. Para los power-ups se diseñará cada uno en el estilo de la segunda foto.



[Assets	](https://groovymcgee.itch.io/car-game-pixel-art)					[Power-Ups](https://www.pinterest.cl/pin/AWAuqbZ7iO41AmLsg242xPrq-ZvK_2DSh8gEzwq_-RcoP_iNtF_P5gM/)
...
[Circuito](https://mario-kart.fandom.com/es/wiki/Circuito_Mario_3)					 [Interfaz](https://en.wikipedia.org/wiki/Mario_Kart_DS)
